...
export default function TeamPage() {
    ...
    const init = async () => {
      try {
        ...
        if (memberRes && memberRes.organization && canViewTeam(memberRes.role)) {
          ...
          await fetchData(memberRes.organization, canManageTeam(memberRes.role));
  ...
  const fetchData = async (orgId: string, canManage: boolean) => {
    try {
      ...
      setMembers(membersRes as unknown as TeamMember[]);
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1">
          {canManageTeam(memberRole)
            ? 'Invite and manage members of your organization.'
            : 'View the members currently associated with your organization.'}
        </p>
      </div>
      ...
      <div className="space-y-8">
                ...
                return (
                  <li key={member.id} className="p-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {canManageTeam(memberRole) && user?.id !== member.user && (
        ...
        {/* Pending Invites */}
        {canManageTeam(memberRole) && invites.length > 0 && (
          <div>
