...
export default function Footer() {
  ...
  return (
    <footer className="bg-white text-gray-500 w-full mt-auto border-t border-gray-200">
      {/* Changed max-w-7xl to w-full and adjusted padding */}
      <div className="w-full px-6 lg:px-12 py-8 flex flex-col md:flex-row justify-between items-center text-sm">
